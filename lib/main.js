...
var COMMANDS = {
	...
	"Logging and Roles": [{
		...
		name: "roleslist",
		desc: "Shows basic info about roles on the server."
	}, {
		name: "biasstats",
		desc: "Shows how many members belong to each role."
	}],
	"Toggles": [{
		name: "toggle image",
		desc: "Changes between embed disabled for images in message logs."
	}, {
		name: "toggle logs",
		desc: "Toggles the logs functionality."
	}, {
		name: "toggle greeter",
		desc: "Toggles the greeter functionality."
	}, {
		name: "toggle roles",
		desc: "Toggles the roles functionality."
	}, {
		name: "toggle adblock",
		desc: "Toggles the ability to post discord links."
	}, {
		name: "toggle starboard",
		desc: "Toggles the starboard functionality."
	}],
	"Misc": [{
		name: "color",
		...
		name: "horoscope",
		desc: "Will display your saved horoscope info for the current day."
	}, {
		name: "horoscope",
		usage: "set [horoscope]",
		desc: "Saves your horopscope."
	}, {
		name: "horoscope",
		usage: "list",
		desc: "Shows a list of all horoscope names."
	}, {
		name: "horoscope",
		usage: "yesterday",
		desc: "Will display your saved horoscope info for the previous day."
	}, {
		name: "horoscope",
		usage: "tomorrow",
		desc: "Will display your saved horoscope info for the next day."
	}],
	"Mod Commands": [{
		name: "setprefix",
		usage: "[prefix]",
		...
		name: "unban",
		usage: "[ID] [reason]",
		desc: "Unbans a user from the server for [reason]."
	}, {
		name: "kick",
		usage: "[@user or ID] [reason]",
		desc: "Kicks a user for [reason]."
	}, {
		name: "say",
